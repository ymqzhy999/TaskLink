...
CREATE TABLE `tasks` (
  ...
  `trigger_time` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '????ʱ?? HH:mm',
  `action_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '????: APP/LINK/CALL',
  `target_value` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '????/URL/?绰',
  `is_active` tinyint(1) DEFAULT '1' COMMENT '????: 1-????, 0-ͣ?',
  ...
  KEY `fk_user_task` (`user_id`) USING BTREE,
