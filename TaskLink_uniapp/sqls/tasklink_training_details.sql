...
CREATE TABLE `training_details` (
  ...
  `word_text` varchar(100) DEFAULT NULL,
  `word_trans` varchar(255) DEFAULT NULL,
  `quality` tinyint DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `session_id` (`session_id`),
  CONSTRAINT `training_details_ibfk_1` FOREIGN KEY (`session_id`) REFERENCES `training_sessions` (`id`) ON DELETE CASCADE
