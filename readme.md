...
1. 在项目根目录下创建一个文件夹：`docs/images/`。
2. 把你的应用截图（建议 4 张核心界面）分别命名为下面代码中对应的名字，放进那个文件夹里即可。

以下是包含图片占位符的完整 `README.md`：
...
| 🧠 战术规划终端 (AI Planner) | 📊 核心指挥看板 (Dashboard) |
| :---: | :---: |
| ![战术生成页](docs/images/screenshot_add.png) | ![首页看板](docs/images/screenshot_index.png) |
| *▲ 接入 DeepSeek 的沉浸式生成界面* | *▲ 赛博朋克风格的任务概览* |
